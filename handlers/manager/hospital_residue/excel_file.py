...
@dp.message_handler(
    lambda message: (str(message.text).__eq__(latin['EXCEL_PATH']) or str(message.text).__eq__(
        russian['EXCEL_PATH']) or str(
        message.text).__eq__(translate_cyrillic_or_latin(latin['EXCEL_PATH'], 'cyr'))) and (
